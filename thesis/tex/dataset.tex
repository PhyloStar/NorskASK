\chapter{The ASK corpus} \label{ch:dataset}
...
\textcite{carlsen2012proficiency}.} in total, have been assigned \iac{CEFR}
...
\section{Data split} \label{sec:datasplit}
...
\begin{table}
  ...
  \caption[Essay topics in development and test sets]{
    The topics chosen to be in each of the development and test sets. All
    other topics are assigned to the training set.
  }
