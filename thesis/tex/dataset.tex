...
This is a paragraph from a text written by a native English speaker from
Australia.
...
The ASK corpus has been subject to several studies on learner language and
transfer from \ac{L1}.
...
\citeauthor{golden2016ask} 

Another study \autocite{vigrestad2015ortografi} which also is based on the
ASK corpus looks at orthographical mistakes in Norwegian learner language.
Certain patterns emerged. For instance, spelling mistakes involving
substitutions of `i' and `y' occurred in learners without the phonological
distinction in their \ac{L1}. Similarly, mistakes involving single/double
consonants were common for speakers that do not distinguish between long and
short vowels in their \ac{L1}.
