...
for the total number of features. The neural models restrict the number of
features to the 10,000 most common.
...
times the word form occurs in the document.
...
\begin{table}
  ...
  \begin{tabular}{lrrrr}
    ...
    MLP POS    &         $0.254$  &         $0.390$  & $\mathbf{0.425}$ &         $0.691$ \\
    MLP Mix    & $\mathbf{0.256}$ & $\mathbf{0.447}$ &         $0.401$  &         $0.699$ \\
    \bottomrule
  \end{tabular}
