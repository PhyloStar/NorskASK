...
\begin{table}
  ...
  \begin{tabular}{lrrrr}
    ...
    % \midrule
    % $ROW MLPR BOW:    mlp_bow-26436597_17 mlp_bow-26436607_17
    % $ROW MLPR Char:   mlp_char-26436597_18 mlp_char-26436607_18
    % $ROW MLPR POS:    mlp_pos-26436597_19 mlp_pos-26436607_19
    % $ROW MLPR Mix:    mlp_mix-26436597_20 mlp_mix-26436607_20
    % $END autotable
    ...
    \midrule
    MLPR BOW & $0.246$ & $0.341$ & $0.458$ & $\mathbf{0.715}$ \\
    MLPR Char & $0.286$ & $0.341$ & $0.468$ & $0.707$ \\
    MLPR POS & $0.273$ & $0.390$ & $0.418$ & $0.699$ \\
    MLPR Mix & $0.252$ & $\mathbf{0.423}$ & $0.440$ & $0.650$ \\
    \bottomrule
  \end{tabular}
...
models, the support vector regressor clearly outperforms the classifiers.

\todo{this was written before SVR was so good}
