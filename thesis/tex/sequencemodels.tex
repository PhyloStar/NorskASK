...
\todo{This goes in a subsection somewhere}
...
\todo{find the right reference}
The Mixed POS mode was inspired by \textcite{malmasi15}. They tried using as
input a mix of word forms and POS tags, so that common function words appeared
in their written form, while content words were substituted for their POS tag.
...
\begin{table}
  ...
  \begin{tabular}{lrrrr}
    ...
    Rnd. init &         $00000$  &         $00000$  &         $00000$  &         $00000$  \\
    %           rnn-25983020                          rnn-25983021
    Pre train &         $00000$  &         $00000$  &         $00000$  &         $00000$  \\
    \bottomrule
  \end{tabular}
